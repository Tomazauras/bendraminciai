...
router
  ...
  .get(postsController.getPostsById);

router.route("/deleteCategory").post(categoryController.delete);

router
  .route("/reservations/post/:postId")
  .get(reservationController.getReservationsByPostId);
...
router
  .route("/user/:userId/creditsSubtract")
  .post(userController.subtractCredits);

router.route("/userType").post(userController.getUserType);

router.route("/profileOpen").post(userController.navigateToProfile);
